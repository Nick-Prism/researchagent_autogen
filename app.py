...
# pip install -r requirements.txt (at the first time)
# pip install //name// (individually if you want to install i.e, if everything isn't installed at once)

#streamlit run app.py (at the last)